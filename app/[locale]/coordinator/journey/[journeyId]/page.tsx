...
import {
    JourneyStateBadge,
    type JourneyState,
} from "@/components/dashboard/journey-state-badge";
  ...
  async function handleTransition() {
    ...
    try {
      ...
      if (data.success) {
        ...
        console.error(
          "Transition failed:",
          data.message || "Failed to transition state",
        );
      }
    } catch (error) {
        ...
        <DialogContent>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Select
                value={targetState}
                onValueChange={(v) => setTargetState(v as JourneyState)}
              >
                <SelectTrigger>
