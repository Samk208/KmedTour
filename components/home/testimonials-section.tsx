    ...
    <section className="w-full py-20 md:py-32 bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto max-w-[1240px] px-4 sm:px-6">
        ...
        <div className="text-center space-y-4 mb-16">
          ...
          >
            {t('landing.testimonials.title') || "Real Stories from Real Patients"}
          </h2>
          <p
            className="text-lg max-w-2xl mx-auto leading-relaxed"
            style={{ color: 'var(--deep-grey)' }}
          >
            {t('landing.testimonials.subtitle') || "Hear from African patients who have successfully received world-class medical treatment in Korea through Kmedtour."}
          </p>
        </div>
